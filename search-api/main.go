...
// Document is a struct which defines a document
...
// DocumentRequest is a struct which defines a document request
type DocumentRequest struct {
	Title   string `json:"title"`
	Content string `json:"content"`
}

// DocumentResponse is a struct which defines a document response
...
// SearchResponse is a struct which defines a search response
